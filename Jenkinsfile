    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                bat 'copy C:\\Users\\TAI8\\AppData\\Local\\Jenkins\\.jenkins\\workspace\\git_test_new\\web\\target\\*.war D:\\work_dsi\\Middleware(Tomee_Java)\\windows_&_linux_tomee\\apache-tomee-plus-8.0.5\\webapps\\'
				// start tomcat
